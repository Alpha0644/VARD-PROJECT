                    ...
                    >
                        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm pointer-events-auto p-6 relative">
                            ...
                            <div className="text-center mb-6">
                                <h2 className="text-xl font-bold text-gray-900">Noter la mission</h2>
                                <p className="text-gray-500 mt-1">
                                    Comment s'est passée la mission avec <span className="font-semibold text-gray-900">{agentName}</span> ?
                                </p>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <textarea
                                    ...
                                    placeholder="Ponctualité, professionnalisme..."
